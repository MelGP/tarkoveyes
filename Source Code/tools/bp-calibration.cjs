 ...
 * right the tactical artwork at the coordinates tools/place-battlepass.cjs
 ...
 *
 *   node tools/bp-calibration.cjs            all maps
 *   node tools/bp-calibration.cjs customs    one map
 *
...
function loadSharp() {
  const candidates = [
    'sharp',
    'C:/Users/lagmy/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/node_modules/sharp'
  ];
  ...
  throw Error('sharp is not available. Install it, or point loadSharp() at a copy.');
}

const sharp = loadSharp();
const root = path.resolve(__dirname, '../app');
const defs = require('../app/data/maps.json');
const spawns = require('../app/data/battlepass-spawns.json');
const placement = require('../app/data/battlepass-placement.json');
