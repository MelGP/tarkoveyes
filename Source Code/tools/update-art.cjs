 ...
 *
 *   node tools/update-art.cjs                 both sets, skipping what exists
 *   node tools/update-art.cjs --quests        quest pictures only
 *   node tools/update-art.cjs --bosses        boss portraits only
 *   node tools/update-art.cjs --check         report what is missing, download nothing
 */
