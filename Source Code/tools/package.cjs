...
for(const item of ['app','main.cjs','preload.cjs','core.cjs','items.cjs','licenses','LICENSE','THIRD-PARTY.md'])fs.cpSync(path.join(root,item),path.join(app,item),{recursive:true});
