 ...
 *
 *   npx electron tools/build-templates.cjs          fetch what is missing
 *   npx electron tools/build-templates.cjs --check  report without writing
 *   npx electron tools/build-templates.cjs --all    rebuild every template
 *
