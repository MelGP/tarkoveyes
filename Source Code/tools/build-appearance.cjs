 ...
 *
 *   npx electron tools/build-appearance.cjs          build the missing ones
 *   npx electron tools/build-appearance.cjs --check  report without writing
 *   npx electron tools/build-appearance.cjs --all    rebuild every signature
 *
