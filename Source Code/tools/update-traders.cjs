 ...
 *
 *   node tools/update-traders.cjs           download what is missing
 *   node tools/update-traders.cjs --check    report without downloading
 *   node tools/update-traders.cjs --force    re-download everything
 */
