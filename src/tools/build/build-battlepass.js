...
const sourceDir = path.join(import.meta.dirname, '../sources/battlepass');
...
export { parseLiteral, parseMapData };
/* "was I run directly, rather than imported?" - require.main is a
   CommonJS idea. In ESM the entry point is argv[1], compared as a URL
   so that a Windows path and a file:// URL do not miss each other. */
