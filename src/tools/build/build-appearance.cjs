 ...
 *
 *   npx electron tools/build/build-appearance.cjs          build the missing ones
 *   npx electron tools/build/build-appearance.cjs --check  report without writing
 *   npx electron tools/build/build-appearance.cjs --all    rebuild every signature
 *
...
const { signatureOf, signatureBytes } = require('../../appearance.cjs');
