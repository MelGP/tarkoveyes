 ...
 *
 *   node tools/build/build-keys.cjs                    write app/data/keys.json
 *   node tools/build/build-keys.cjs --download-icons   also fetch the key images
 *   node tools/build/build-keys.cjs --check   report without writing
 */
