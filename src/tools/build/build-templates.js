 ...
 *
 *   npx electron tools/build/build-templates.js          fetch what is missing
 *   npx electron tools/build/build-templates.js --check  report without writing
 *   npx electron tools/build/build-templates.js --all    rebuild every template
 *
...
import { cell, bandRows, packRecord } from '../../lib/templates.js';
...
const concurrency = 8;
fs.mkdirSync(path.join(os.tmpdir(), 'tarkoveyes-grid-artwork'), { recursive: true });
...
const artwork = path.join(os.tmpdir(), 'tarkoveyes-grid-artwork');
