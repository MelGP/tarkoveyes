 ...
 *
 *   node tools/build/build-keys.js                    write app/data/keys.json
 *   node tools/build/build-keys.js --download-icons   also fetch the key images
 *   node tools/build/build-keys.js --check   report without writing
 */
