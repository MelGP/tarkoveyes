 ...
 *
 *   node tools/update/update-traders.js           download what is missing
 *   node tools/update/update-traders.js --check    report without downloading
 *   node tools/update/update-traders.js --force    re-download everything
 */
