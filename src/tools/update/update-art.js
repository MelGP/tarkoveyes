 ...
 *
 *   node tools/update/update-art.js                 both sets, skipping what exists
 *   node tools/update/update-art.js --quests        quest pictures only
 *   node tools/update/update-art.js --bosses        boss portraits only
 *   node tools/update/update-art.js --check         report what is missing, download nothing
 */
