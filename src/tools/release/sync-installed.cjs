 ...
 *
 *   node tools/release/sync-installed.cjs --check   report differences, write nothing
 *   node tools/release/sync-installed.cjs           copy the differences and update the manifest
 *
 ...
 *
 * package.json is also left out on purpose. tools/release/package.cjs writes a trimmed
