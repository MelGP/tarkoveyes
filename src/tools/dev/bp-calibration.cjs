 ...
 * right the tactical artwork at the coordinates tools/build/place-battlepass.cjs
 ...
 *
 *   node tools/dev/bp-calibration.cjs            all maps
 *   node tools/dev/bp-calibration.cjs customs    one map
 *
